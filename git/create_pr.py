...
htmlTree = html.fromstring(pullRequestPageRequest.content)
authenticity_token = htmlTree.xpath('//*[@id="new_pull_request"]/input[1]')[0].get('value')
timestamp = htmlTree.xpath('//*[@id="new_pull_request"]/div/div[1]/div/div[2]/input[2]')[0].get('value')
timestamp_secret = htmlTree.xpath('//*[@id="new_pull_request"]/div/div[1]/div/div[2]/input[3]')[0].get('value')
required_feild = htmlTree.xpath('//*[@id="new_pull_request"]/div/div[1]/div/div[2]/input[1]')[0].get('name')
