			...
			echo('<a href="?id='.htmlspecialchars($csv[ID],ENT_QUOTES).'" class="nostyle">
						...
						<div class="vita-app" onclick="open_url(\'?id='.htmlspecialchars($csv[ID],ENT_QUOTES).'\');">
							<div class="vita-app-icon">
								...
								<img src="img/BubbleOverlay.png" width="128" height="128"class="bubble-overlay"></img>
								<img src="'.htmlspecialchars($DEFAULT_ICON0,ENT_QUOTES).'" loading="lazy" onerror="on_error(event.target,\''.htmlspecialchars($csv[ID],ENT_QUOTES).'\','.(string)$plugins.');" width="128" height="128" class="bubble"></img>
							</div><br>
...
$time_taken = (microtime(true) - $old_timestamp);
