...
(function() {
	var cors_api_url = '/proxy.php?url=';
	var slice = [].slice;
	...
	XMLHttpRequest.prototype.open = function() {
		...
		// If cross-origin and not already using the proxy, rewrite the URL
		if (
			targetOrigin &&
			targetOrigin[0].toLowerCase() !== origin &&
			args[1].indexOf(cors_api_url) !== 0 // avoid double-proxying
		) {
...
{	
	...
	xhr.addEventListener("load", function(){ 
		...
		if(url.toLowerCase().indexOf("vpk") != -1)
		{
			set_type("VPK");
		}
...
{
	rdme = document.getElementById("readme_url_entry").value;
	if(rdme == "")
		rdme = "None"
	form_download_readme.value = rdme;
...
{
	credits = document.getElementById("credits_entry").value;
	if(credits == "")
		credits = "None"
	form_credits.value = credits
...
<div class="applist">
	<div class="submit-box">
		...
		<div id="terms_of_service" class="submit-form" >
			...
			<div class="submit-tos">
				<ul>
					<li>Homebrew containing malicious code.</li>
					<li>Homebrew that contains information pertaining to personal information of one who does not wish that information to be released.</li>
					<li>Homebrew that does not use the officially provided release binary that the developers provides, unless that binary is not proper format provided for CBPSD. On that occasion a mirror will be used.</li>
					<li>Homebrew that has retail privilege (retail games or retail application) unless the intent of this subject has changed beyond recognition in that its original purpose has changed.</li>
					<li>Homebrew that are illegal in the jurisdiction of the US, exclusive of the tools used to generate the homebrew.</li>
					<li>Homebrew submission with the intent to take down CBPSDB.</li>
				</ul>
			</div>
		...
		<div id="enter_icon0" class="submit-form" >
			...
			<img src="/img/app_default.png" onerror="image_load_failed()" width="128" height="128" class="bubble" id="submit_icon0_preview"><br>
		...
		<div id="enter_scope" class="submit-form" >
			...
			<div class="submit-skip">
					<font size="2%"><a onclick="_360_no_scope()" class="white">No config entry?</a></font>
			</div>
		...
		<div id="enter_type" class="submit-form">
			...
			<div class="submit-option" onclick="set_type('PLUGIN');">
				<div class="submit-action-icon">
					<img src="/img/plugin_tai.png" width="128" height="128">
				</div>
				<p>Plugin</p>
				<font size="2%">
		...
		<div id="enter_config_type" class="submit-form">
			...
			<div class="submit-option" onclick="set_config_type('BOOT');">
				<div class="submit-action-icon">
					<img src="/img/plugin_boot.png" width="128" height="128">
				</div>
				<p><b>Boot Plugin</b></p>
				<font size="2%">
